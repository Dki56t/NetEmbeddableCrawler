...
namespace Tests.UnitTests
{
    public class UrlMapperTest
    {
        ...
        public void TestFileNameAppendExtension()
        {
            ...
            Assert.Equal(mapper.GetPath("http://site1/"), Path.Combine(_testDirectoryPath, "site1\\index.html"));
        ...
        public void TestMapping()
        {
            ...
            Assert.Equal(mapper.GetPath("http://site2/otherinternal/some.html"),
        ...
        public void TestMappingAbnormal()
        {
            ...
            Assert.Equal(mapper.GetPath("http://site3/"), Path.Combine(_testDirectoryPath, "site3\\index.html"));
        ...
        public void TestMappingPartial()
        {
            ...
            Assert.Equal(mapper.GetPath("http://site4/#"), Path.Combine(_testDirectoryPath, "site4\\index.html"));
