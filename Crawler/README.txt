...
8. Если при попытке скачать контент удаленным сервером выдается исключение вида разрыва соединения (ru.linkedin.com, например) контент не скачивается,
	ссылка на него в исходном html остается без изменений, исключение подавляется.
